...
The GitHub workflow `.github/workflows/finalize-rival-posters.yml` runs this import, the test suite, production build, and Cast V3 coverage audit whenever the numbered source posters/catalog/finaliser change on `work/final-awards-rival-posters`.

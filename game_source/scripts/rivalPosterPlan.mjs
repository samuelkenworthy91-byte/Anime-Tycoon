...
const SLOTS = [
  ...
  { st: "Turtle Line", slug: "kwaiimech", types: ["shojo"], genres: ["mecha", "magical"], wave: 3,
    prompt: "pastel magical mecha with ribbon detailing standing guard over a dreamlike flower city, high jewelry couture" },

  /* ----------------------------------------------------- SPARES (wave 4)
     24 extra slots — 4 per studio — held in reserve so the selection engine
     always has unused, never-repeated posters behind the core slate. */
  { st: "Toe-i Animation", slug: "sparesun", types: ["shonen"], genres: ["sports", "martial"], wave: 4,
    prompt: "underdog fighter silhouetted against a stadium sunrise with bandaged fists raised" },
  { st: "Toe-i Animation", slug: "sparetide", types: ["shonen"], genres: ["pirate", "supernatural"], wave: 4,
    prompt: "cursed galleon captain facing a wall of ghostly green tide under a torn red sky" },
  { st: "Toe-i Animation", slug: "sparezero", types: ["shonen"], genres: ["space", "military"], wave: 4,
    prompt: "massive squadron carrier launching fighters from its spinal rails, huge scale" },
  { st: "Toe-i Animation", slug: "sparekaiju", types: ["shonen"], genres: ["supernatural", "mythology"], wave: 4,
    prompt: "colossal mythic beast walking out of the temple-city skyline at dusk, tiny crowds below" },
  { st: "Sunnyrise", slug: "sparesolar", types: ["shonen"], genres: ["space", "mystery"], wave: 4,
    prompt: "solar-sail vessel catching a ribbon of light between star systems, lens-flare precision" },
  { st: "Sunnyrise", slug: "spareforge", types: ["shonen"], genres: ["mecha", "military"], wave: 4,
    prompt: "heavy forge-frame mecha mid-assembly in a cathedral-scale hangar, sparks raining" },
  { st: "Sunnyrise", slug: "sparecrypto", types: ["shonen", "shojo"], genres: ["cyber", "mystery"], wave: 4,
    prompt: "hooded figures sharing a holographic cypher inside a flooded server cathedral" },
  { st: "Sunnyrise", slug: "sparetundra", types: ["shojo"], genres: ["nordic", "mystery"], wave: 4,
    prompt: "arctic survey rover crossing a frozen sea beneath a fractured moon" },
  { st: "Boneworks", slug: "spareobe", types: ["shojo"], genres: ["supernatural", "romance"], wave: 4,
    prompt: "weightless sleeper drifting above an empty chandelier ballroom, dreaming" },
  { st: "Boneworks", slug: "sparehive", types: ["shonen"], genres: ["horror", "survival"], wave: 4,
    prompt: "spelunkers discovering a luminescent organic hive beneath the school boiler house" },
  { st: "Boneworks", slug: "sparevale", types: ["shonen", "shojo"], genres: ["mystery", "isekai"], wave: 4,
    prompt: "two students stepping through a torn paper-film strip into a mirrored vale" },
  { st: "Boneworks", slug: "spareclinic", types: ["shonen"], genres: ["horror", "cyber"], wave: 4,
    prompt: "sterile night clinic corridor with a lone flickering holo-vitals wall" },
  { st: "Kyo-Hani", slug: "spareharvest", types: ["shojo"], genres: ["slice", "cooking"], wave: 4,
    prompt: "family long-table dinner in a peach orchard at gold hour, hands passing dishes" },
  { st: "Kyo-Hani", slug: "sparezephyr", types: ["shojo"], genres: ["romance", "fantasy"], wave: 4,
    prompt: "lovers exchanging farewell letters on a zeppelin deck above dawn clouds" },
  { st: "Kyo-Hani", slug: "spareempire", types: ["shonen", "shojo"], genres: ["mythology", "military"], wave: 4,
    prompt: "would-be empress walking out of a conquered throne room, banners smoldering" },
  { st: "Kyo-Hani", slug: "sparerail", types: ["shojo"], genres: ["slice", "romance"], wave: 4,
    prompt: "two runaways on the last snow-country rail, faces lit by passing window lanterns" },
  { st: "Madcap House", slug: "sparebuffet", types: ["shonen", "shojo"], genres: ["cooking", "comedy"], wave: 4,
    prompt: "all-you-can-eat tournament buffet with flying plates and a cheering kitchen crew" },
  { st: "Madcap House", slug: "sparewap", types: ["shonen"], genres: ["isekai", "comedy"], wave: 4,
    prompt: "delivery dragon landing badly on a thatch-roof mail depot, parcels everywhere" },
  { st: "Madcap House", slug: "sparepowerup", types: ["shonen", "shojo"], genres: ["magical", "sports"], wave: 4,
    prompt: "magical girl power-up sequence gone spectacularly sideways on the sports field" },
  { st: "Madcap House", slug: "sparenightout", types: ["shojo"], genres: ["slice", "romance"], wave: 4,
    prompt: "sleepover flash-photo of marshmallow-roasting roommates in blanket capes" },
  { st: "Turtle Line", slug: "sparestarfall", types: ["shojo"], genres: ["idol", "space"], wave: 4,
    prompt: "idol reaching for falling comet light above a silent amphitheatre crowd" },
  { st: "Turtle Line", slug: "sparepetal", types: ["shojo"], genres: ["romance", "idol"], wave: 4,
    prompt: "petal-storm finale with the lead locking eyes with one person in the front row" },
  { st: "Turtle Line", slug: "spareprismwalk", types: ["shojo"], genres: ["idol", "cyber"], wave: 4,
    prompt: "hologram runway idols passing through each other's light-bodies mid-strut" },
  { st: "Turtle Line", slug: "sparearia", types: ["shojo"], genres: ["romance", "nordic"], wave: 4,
    prompt: "opera singer practicing an aria alone in a frost-windowed gothic hall" },
];

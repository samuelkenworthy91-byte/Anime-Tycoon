...
export default function BigThreeBoard({ run }: { run: RunState }) {
  ...
  return (
    <section className="mb-4 rounded-2xl border border-gold/40 bg-gradient-to-br from-gold/10 via-panel2/80 to-viol/10 p-3">
      ...
      {!run.bigThree.introduced && <div className="mt-3 rounded-xl border border-dashed border-line p-3 text-center text-[10px] text-paper/45"><Lock size={14} className="mx-auto mb-1"/>The first Big Three can be named from March of Year 5.</div>}

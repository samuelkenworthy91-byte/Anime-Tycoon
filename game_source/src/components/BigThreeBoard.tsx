    ...
    <section className="mb-4 rounded-2xl border border-gold/40 bg-gradient-to-br from-gold/10 via-panel2/80 to-viol/10 p-3">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-[9px] text-paper/50">Fan-decided cultural canon · three permanent monuments for this era</div><div className="mt-0.5 text-[8px] text-gold/65">38+/40 · 150,000+ franchise following · elite craft · sustained cultural momentum · at least 48 weeks between inductions</div>
        </div>
      </div>
      {!run.bigThree.introduced && <div className="mt-3 rounded-xl border border-dashed border-line p-3 text-center text-[10px] text-paper/45"><Lock size={14} className="mx-auto mb-1"/>The cultural landscape changes in Year 3.</div>}

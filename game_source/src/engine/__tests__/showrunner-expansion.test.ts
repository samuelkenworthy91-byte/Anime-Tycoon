...
describe("showrunner expansion", () => {
  it("exposes eight unique playable identities with valid paired artwork and save IDs", () => {
    expect(SHOWRUNNERS.map(s => s.id)).toEqual(["steady", "vision", "producer", "marketer", "operations", "franchise", "mentor", "research"]);

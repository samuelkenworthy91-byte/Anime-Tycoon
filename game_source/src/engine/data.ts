...
export const PROTAGONISTS: CastMember[] = [
  ...
  reg({ id: "hikari", name: "Hikari", archetype: "Prism Wish", img: "img/cast4/hikari.jpg", tag: "Transforms homework into miracles.", aff: ["shojo", "fantasy", "romance"], role: "protag" }),
  reg({ id: "rei", name: "Rei", archetype: "Steel Resolve", img: "img/cast4/rei.jpg", tag: "Sync rate: 400% on Mondays.", aff: ["mecha", "cyber", "mystery"], role: "protag" }),
  reg({ id: "sora", name: "Sora", archetype: "Skyblade", img: "img/cast4/sora.jpg", tag: "Reincarnated with max charisma.", aff: ["isekai", "fantasy", "shonen"], role: "protag" }),
  ...
  reg({ id: "airi", name: "Airi", archetype: "Center Stage", img: "img/cast4/airi.jpg", tag: "Streams at 3AM, still sparkling.", aff: ["idol", "shonen", "slice"], role: "protag" }),
  ...
  reg({ id: "rin", name: "Rin", archetype: "Thunderstep", img: "img/cast4/rin.jpg", tag: "Laps everyone at full sprint.", aff: ["sports", "shonen", "slice"], role: "protag" }),
  ...
  reg({ id: "taro", name: "Taro", archetype: "Iron Chef", img: "img/cast4/taro.jpg", tag: "Cooks for the whole guild.", aff: ["slice", "sports", "fantasy"], role: "protag" }),
  ...
  reg({ id: "kenta", name: "Kenta", archetype: "Punchline", img: "img/cast4/kenta.jpg", tag: "Jokes first, uppercuts second.", aff: ["shonen", "sports", "idol"], role: "protag" }),
  ...
  reg({ id: "jin", name: "Jin", archetype: "Ghost Driver", img: "img/cast4/jin.jpg", tag: "Drifts through traffic and timelines.", aff: ["mecha", "cyber", "sports"], role: "protag" }),
  reg({ id: "emi", name: "Emi", archetype: "Cottage Witch", img: "img/cast4/emi.jpg", tag: "Brews tea and minor miracles.", aff: ["fantasy", "slice", "romance"], role: "protag" }),
  ...
  reg({ id: "daichi", name: "Daichi", archetype: "Earthbreaker", img: "img/cast4/daichi.jpg", tag: "Boulders flinch first.", aff: ["shonen", "fantasy", "sports"], role: "protag" }),
  ...
  reg({ id: "mira", name: "Mira", archetype: "Nebula Singer", img: "img/cast4/mira.jpg", tag: "Her high notes bend gravity.", aff: ["idol", "cyber", "fantasy"], role: "protag" }),
  ...
  reg({ id: "akira", name: "Akira", archetype: "Neon Ronin", img: "img/cast4/akira.jpg", tag: "Wanders the rain-lit city.", aff: ["cyber", "shonen", "horror"], role: "protag" }),
  ...
  reg({ id: "shiori", name: "Shiori", archetype: "Wispkeeper", img: "img/cast4/shiori.jpg", tag: "Talks to the lights in the woods.", aff: ["horror", "fantasy", "mystery"], role: "protag" }),
  ...
  reg({ id: "renji", name: "Renji", archetype: "Silent Snow", img: "img/cast4/renji.jpg", tag: "Speaks once, and it matters.", aff: ["mystery", "romance", "cyber"], role: "protag" }),
  ...
  reg({ id: "sen", name: "Sen", archetype: "Scarred Blade", img: "img/cast4/sen.jpg", tag: "The scar remembers so he doesn't have to.", aff: ["shonen", "mystery", "horror"], role: "protag" }),
  reg({ id: "zuri", name: "Zuri", archetype: "Gearsmith", img: "img/cast4/zuri.jpg", tag: "Builds it twice, breaks it once.", aff: ["mecha", "sports", "fantasy"], role: "protag" }),
  reg({ id: "ash", name: "Ash", archetype: "Green Arrow", img: "img/cast4/ash.jpg", tag: "Never misses. Never brags.", aff: ["fantasy", "isekai", "mystery"], role: "protag" }),
  reg({ id: "kuro", name: "Kuro", archetype: "Red Coat", img: "img/cast4/kuro.jpg", tag: "Trouble finds him. He charges it rent.", aff: ["cyber", "shonen", "horror"], role: "protag" }),
  reg({ id: "tsubasa", name: "Tsubasa", archetype: "Sky Wrench", img: "img/cast4/tsubasa.jpg", tag: "Flies first, files paperwork never.", aff: ["mecha", "isekai", "sports"], role: "protag" }),
  reg({ id: "itsuki", name: "Itsuki", archetype: "Ink & Lamplight", img: "img/cast4/itsuki.jpg", tag: "Writes the ending before the start.", aff: ["romance", "mystery", "slice"], role: "protag" }),
  reg({ id: "suzume", name: "Suzume", archetype: "Foxfire Maiden", img: "img/cast4/suzume.jpg", tag: "The shrine bells ring when she's angry.", aff: ["fantasy", "horror", "shojo"], role: "protag" }),
  reg({ id: "leo", name: "Leo", archetype: "No Rules", img: "img/cast4/leo.jpg", tag: "Lands the trick on the last take.", aff: ["sports", "slice", "idol"], role: "protag" }),
];
...
export const SECONDARY: CastMember[] = [
  ...
  reg({ id: "s_okada", name: "Okada", archetype: "The Old Sensei", img: "img/cast4/s_okada.jpg", tag: "Wise, gruff, secretly soft.", aff: ["sports", "shonen", "slice"], role: "secondary" }),
  reg({ id: "s_kiki", name: "Kiki", archetype: "The Comedic Engine", img: "img/cast4/s_kiki.jpg", tag: "Falls up the stairs. Saves the day.", aff: ["slice", "shonen", "idol"], role: "secondary" }),
  ...
  reg({ id: "s_chiaki", name: "Chiaki", archetype: "The Transfer Student", img: "img/cast4/s_chiaki.jpg", tag: "Knows things they shouldn't.", aff: ["mystery", "horror", "cyber"], role: "secondary" }),
  ...
  reg({ id: "s_takeshi", name: "Takeshi", archetype: "The Drill Coach", img: "img/cast4/s_takeshi.jpg", tag: "No pain, no montage.", aff: ["sports", "shonen", "mecha"], role: "secondary" }),
  ...
  reg({ id: "s_haruto", name: "Nyanko", archetype: "The Streetwise Cat", img: "img/cast4/s_haruto.jpg", tag: "Nine lives, one master plan.", aff: ["slice", "shonen", "mystery"], role: "secondary" }),
  ...
  reg({ id: "s_gen", name: "Gen", archetype: "The Lazy Genius", img: "img/cast4/s_gen.jpg", tag: "Solved it while napping.", aff: ["mystery", "cyber", "slice"], role: "secondary" }),
  ...
  reg({ id: "s_aoi", name: "Aoi", archetype: "The Weather Girl", img: "img/cast4/s_aoi.jpg", tag: "Smiles through any storm.", aff: ["slice", "romance", "shojo"], role: "secondary" }),
  reg({ id: "s_shin", name: "Pip", archetype: "The Alien Analyst", img: "img/cast4/s_shin.jpg", tag: "Flew 40 light-years for this plot.", aff: ["mystery", "cyber", "horror"], role: "secondary" }),
  ...
  reg({ id: "s_koko", name: "Koko", archetype: "The Mystic Cat", img: "img/cast4/s_koko.jpg", tag: "Predicts cliffhangers. Demands tuna.", aff: ["mystery", "fantasy", "horror"], role: "secondary" }),
  reg({ id: "s_sosuke", name: "Sosuke", archetype: "The Automaton Butler", img: "img/cast4/s_sosuke.jpg", tag: "Polished. Unreadable. Battery at 99%.", aff: ["mystery", "mecha", "slice"], role: "secondary" }),
  /* --- wave two (sheets 9-10) --- */
  ...
  reg({ id: "s_tobi", name: "Tobi", archetype: "The Rookie Reporter", img: "img/cast4/s_tobi.jpg", tag: "Shutter first, questions later.", aff: ["slice", "mystery", "cyber"], role: "secondary" }),
  reg({ id: "s_maki", name: "Maki", archetype: "The Rival Ace", img: "img/cast4/s_maki.jpg", tag: "Beats your record, then your excuses.", aff: ["sports", "shonen", "idol"], role: "secondary" }),
];
...
export const PETS: CastMember[] = [
  ...
  reg({ id: "p_pudding", name: "Pudding", archetype: "Wobbly Blob Dog", img: "img/cast4/p_pudding.jpg", tag: "Jiggles when excited.", aff: ["slice", "romance"], role: "pet" }),
  ...
  reg({ id: "p_baku", name: "Baku", archetype: "Dream Eater", img: "img/cast4/p_baku.jpg", tag: "Naps nightmares away.", aff: ["fantasy", "horror"], role: "pet" }),
  ...
  reg({ id: "p_hachi", name: "Hachi", archetype: "Bumblebee", img: "img/cast4/p_hachi.jpg", tag: "Buzzes in harmony.", aff: ["slice", "sports"], role: "pet" }),
...
export const VILLAINS: CastMember[] = [
  reg({ id: "v_kurogane", name: "Kurogane", archetype: "The Iron Tyrant", img: "img/cast4/v_kurogane.jpg", tag: "Ruled by the sword.", aff: ["shonen", "fantasy", "mecha"], role: "villain" }),
  reg({ id: "v_nocturne", name: "Nocturne", archetype: "Queen of Shadows", img: "img/cast4/v_nocturne.jpg", tag: "Darkness obeys her.", aff: ["horror", "mystery", "shojo"], role: "villain" }),
  ...
  reg({ id: "v_tempest", name: "Lord Tempest", archetype: "The Storm Court", img: "img/cast4/v_tempest.jpg", tag: "Weathers every siege.", aff: ["fantasy", "sports", "shonen"], role: "villain" }),
  ...
  reg({ id: "v_moth", name: "Mother Moth", archetype: "The Light That Lures", img: "img/cast4/v_moth.jpg", tag: "Follow her glow.", aff: ["horror", "fantasy", "shojo"], role: "villain" }),
  ...
  /* --- wave two (sheets 9-10) --- */
  reg({ id: "v_amethyst", name: "Empress Amethyst", archetype: "The Violet Crown", img: "img/cast4/v_amethyst.jpg", tag: "Her throne is lit by other people's fire.", aff: ["fantasy", "shojo", "horror"], role: "villain" }),
  reg({ id: "v_gravemark", name: "Gravemark", archetype: "The Cracked Warlord", img: "img/cast4/v_gravemark.jpg", tag: "Armour older than the war.", aff: ["shonen", "fantasy", "horror"], role: "villain" }),
  reg({ id: "v_kairos", name: "CEO Kairos", archetype: "The Friendly Contract", img: "img/cast4/v_kairos.jpg", tag: "Everything is negotiable. Including you.", aff: ["cyber", "mecha", "mystery"], role: "villain" }),
  reg({ id: "v_plague", name: "The Green Doctor", archetype: "The Cure That Isn't", img: "img/cast4/v_plague.jpg", tag: "Prescribes silence.", aff: ["horror", "mystery", "fantasy"], role: "villain" }),
  reg({ id: "v_harlequin", name: "Harlequin", archetype: "The Laughing Trick", img: "img/cast4/v_harlequin.jpg", tag: "The punchline is always you.", aff: ["horror", "mystery", "slice"], role: "villain" }),
  reg({ id: "v_onikage", name: "Onikage", archetype: "The Cursed Blade", img: "img/cast4/v_onikage.jpg", tag: "The mask cracked. He didn't.", aff: ["shonen", "horror", "fantasy"], role: "villain" }),
  reg({ id: "v_hollowchild", name: "The Pale Empress", archetype: "The Quiet Void", img: "img/cast4/v_hollowchild.jpg", tag: "She asks nicely. Once.", aff: ["horror", "shojo", "mystery"], role: "villain" }),
  reg({ id: "v_bioform", name: "Bioform IX", archetype: "The Failed Experiment", img: "img/cast4/v_bioform.jpg", tag: "Built to win. Nobody said at what.", aff: ["mecha", "cyber", "shonen"], role: "villain" }),
];
...
export const CAST_WAVE_THREE: CastMember[] = [
  ...
  reg({ id: "n_ryoko", name: "Ryoko", archetype: "Moonlight Mechanic", img: "img/cast4/n_ryoko.jpg", tag: "Rebuilds fallen stars by hand.", aff: ["mecha", "shojo", "space"], role: "protag" }),
  reg({ id: "n_chisato", name: "Chisato", archetype: "Heartthrob Striker", img: "img/cast4/n_chisato.jpg", tag: "Bends it like Beckham, loves like a shoujo.", aff: ["romance", "sports", "shojo"], role: "protag" }),
  ...
  /* --- pets --- */
  reg({ id: "p_loader", name: "Loader", archetype: "Munitions Mutt", img: "img/cast4/p_loader.jpg", tag: "Digs up more than bones.", aff: ["military", "comedy", "shonen"], role: "pet" }),
  reg({ id: "p_nitro", name: "Nitro", archetype: "Pit-Crew Ferret", img: "img/cast4/p_nitro.jpg", tag: "Torque in a tiny body.", aff: ["racing", "sports", "comedy"], role: "pet" }),
  reg({ id: "p_stellar", name: "Stellar", archetype: "Comet Kitten", img: "img/cast4/p_stellar.jpg", tag: "Chases starlight, catches it.", aff: ["space", "magical", "shojo"], role: "pet" }),

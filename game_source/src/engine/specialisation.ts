...
const RANK_EFFECTS: Record<1 | 2 | 3, RankEffects> = {
  1: {
    ...
    outsideOutput: 0.99,
    outsidePace: 0.99,
    outsideInterventionCost: 1.03,
    outsideRisk: 1.04,
    outsideIssueChance: 1.05,
  },
  2: {
    ...
    outsideOutput: 0.97,
    outsidePace: 0.98,
    outsideInterventionCost: 1.06,
    outsideRisk: 1.08,
    outsideIssueChance: 1.10,
  },
  3: {
    ...
    outsideOutput: 0.95,
    outsidePace: 0.97,
    outsideInterventionCost: 1.10,
    outsideRisk: 1.12,
    outsideIssueChance: 1.15,
  },
};

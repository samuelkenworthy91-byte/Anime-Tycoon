...
First names are gender-locked. Source rows tagged exclusively male or female stay in that pool. Names tagged for both genders are only included for a gender where the source's global gender inference is at least 70%; otherwise they are excluded as ambiguous.
